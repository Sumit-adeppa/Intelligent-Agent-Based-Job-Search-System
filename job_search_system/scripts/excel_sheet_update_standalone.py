...
base_url = "https://thejobcompany.in/"
...
if job_data:
    ...
    # Correct path to the data folder relative to the script location
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_path = os.path.join(script_dir, '..', 'job_search', 'data', 'job_data.xlsx')
